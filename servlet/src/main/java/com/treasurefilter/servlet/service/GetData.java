...
public class GetData {
    public String getdata(String status,
        ...
        ResponseEntity<String> responseEntity=restTemplate.exchange("http://jishi.woniu.com/9yin/anonymous/find"+status+"Goods.do?serverId={serverId}&gameId={gameId}&typeNameParam={typeNameParam}"+urlSortWay+urlSortField+urlPageIndex+urlItemName+bwa+"&_={_}",HttpMethod.GET,requestEntity,String.class,params);
    ...
    public String getServerList(){
        ...
        HttpEntity<String> requestEntity = new HttpEntity<>(null, headers);//将header放入一个请求
        ResponseEntity<String> responseEntity=restTemplate.exchange("http://jishi.woniu.com/9yin/loadServerList.do?gameId={gameId}&_={_}",HttpMethod.GET,requestEntity,String.class,params);
        return responseEntity.getBody();
    }
    public String getFollowCount(String serverId, String itemIds){
        ...
        HttpHeaders headers = requestHeaders.gen("anonymousPage"); //生成请求头
        HttpEntity<String> requestEntity = new HttpEntity<>(null, headers);//将header放入一个请求
        ResponseEntity<String> responseEntity=restTemplate.exchange("http://jishi.woniu.com/9yin/anonymous/getItemsFollowCount.do?serverId={serverId}&gameId={gameId}&itemIds={itemIds}&_={_}",HttpMethod.GET,requestEntity,String.class,params);
        return responseEntity.getBody();
    }
    public String getTradeItem(String serverId, String itemId){
        ...
        HttpHeaders headers = requestHeaders.gen("anonymousPage"); //生成请求头
        HttpEntity<String> requestEntity = new HttpEntity<>(null, headers);//将header放入一个请求
        ResponseEntity<String> responseEntity=restTemplate.exchange("http://jishi.woniu.com/9yin/anonymous/getTradeItem.do?serverId={serverId}&gameId={gameId}&itemId={itemId}&_={_}",HttpMethod.GET,requestEntity,String.class,params);
        return responseEntity.getBody();
    }
}