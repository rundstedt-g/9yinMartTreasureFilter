...
function goodsSort(){
    ...
    goodsSortCon = $('.filter_param_item'),
...
function getTreasure(){
    ...
    var url = "http://localhost:8080/getTreasure?"; //接口
    ...
    function loadTreasure(data){
        ...
        $.each(pageData,function(i,obj) {
            ...
            //出售的剩余时间
            var marks_time = getRemainTime(obj['shelfDate'],obj['shelfDays'],obj['issaleFlag']);
            //宝物技能
...
function getRemainTime(shelfDate,shelfDays,issaleFlag){
...
function getFollowCount(serverId, idSet){
    var url = "http://localhost:8080/getFollowCount?"; //接口
